import{c as S,u as w,r as p,j as o}from"./index-C8O_mb-0.js";import{u as P}from"./useColors-CtvRos8s.js";function F(e,i){const r=(i||"moderate").toLowerCase(),a=new Date().toLocaleDateString("en-US",{month:"short",day:"numeric",year:"numeric"}),s=e.trim().toLowerCase();return/^(hi|hello|hey|yo|help|thanks|thank you|what is floboard|who are you)[.!?]*$/i.test(s)?`Hello! I'm **FloAI**, your AI financial advisor built into FloBoard.
